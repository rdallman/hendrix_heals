...
class ProceduresControllerTest < ActionController::TestCase
  ...
  test "should create procedure" do
    assert_difference('Procedure.count') do
      post :create, procedure: { category: @procedure.category, cost: @procedure.cost, name: @procedure.name, patient_id: @procedure.patient_id, physician_id: @procedure.physician_id, time: @procedure.time }
    end
  ...
  test "should update procedure" do
    patch :update, id: @procedure, procedure: { category: @procedure.category, cost: @procedure.cost, name: @procedure.name, patient_id: @procedure.patient_id, physician_id: @procedure.physician_id, time: @procedure.time }
    assert_redirected_to procedure_path(assigns(:procedure))
  end
